            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <div class="mt-6">
                    <button
                        ...
                        wire:target="triggerWakeUpRoutine"
                    ...
                    >
                        <span wire:loading.remove.delay.default="triggerWakeUpRoutine">
                            Trigger Wake-Up Routine (Generate Daily Plan)
                        </span>
                        <span wire:loading.delay.default="triggerWakeUpRoutine" class="flex items-center gap-2">
