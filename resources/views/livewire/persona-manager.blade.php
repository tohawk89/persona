                ...
                <form wire:submit.prevent="save" class="space-y-6">
                    ...
                    {{-- <div class="border border-gray-300 dark:border-gray-600 rounded-lg p-6 space-y-4">
                        ...
                        <div class="flex justify-center">
                            ...
                            >
                                <span wire:loading.remove.delay.default="optimizePhysicalTraits">✨</span>
                                <svg wire:loading.delay.default="optimizePhysicalTraits" class="animate-spin h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                </svg>
                                <span wire:loading.remove.delay.default="optimizePhysicalTraits">Generate Traits</span>
                                <span wire:loading.delay.default="optimizePhysicalTraits">Optimizing...</span>
                            </button>
                        </div>
                    ...
                    <!-- Passport Photo / Avatar Editor -->
                    @if($persona)
                        <div class="border border-gray-300 dark:border-gray-600 rounded-lg p-6">
                            <h3 class="text-lg font-semibold mb-4">📸 Passport Photo</h3>
                            <livewire:persona-avatar-editor :persona="$persona" :key="'avatar-editor-'.$persona->id" />
                        </div>
                    @else
                        <div class="border border-gray-300 dark:border-gray-600 rounded-lg p-6 bg-gray-50 dark:bg-gray-700">
                            <p class="text-sm text-gray-600 dark:text-gray-400">
                                💡 Save the persona first to enable passport photo creation
                            </p>
                        </div>
                    @endif
