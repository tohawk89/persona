<div>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-2xl font-bold">Test Chat — {{ $persona->name }}</h2>
                    <button
                ...
                <!-- TEST MODE Banner -->
                <div class="bg-yellow-100 dark:bg-yellow-900 border-l-4 border-yellow-500 text-yellow-700 dark:text-yellow-200 p-4 mb-6 rounded-lg shadow-sm">
        ...
        <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                ...
                <div
                    id="chat-container"
                    class="h-[500px] overflow-y-auto p-6 space-y-4 bg-gray-50 dark:bg-gray-900 rounded-lg"
        ...
        <!-- Instructions -->
                <div class="mt-6 bg-blue-50 dark:bg-blue-900 border border-blue-300 dark:border-blue-700 rounded-lg p-4 shadow-sm">
                    <h3 class="font-semibold text-gray-900 dark:text-gray-100 mb-2">💡 Testing Tips</h3>
