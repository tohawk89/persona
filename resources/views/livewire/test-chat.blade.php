        ...
        <!-- Testing Tips -->
                <div class="mt-6 bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-800 rounded-lg p-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            <h3 class="font-semibold text-indigo-900 dark:text-indigo-100 text-sm mb-2">💡 Testing Tips</h3>
                            <ul class="text-sm text-indigo-800 dark:text-indigo-200 space-y-1.5">
